...
export default function OilPaintingBlogPage() {
  return (
    <>
      ...
      {/* Hero */}
      <section className="relative bg-gradient-to-br from-gray-950 via-amber-950 to-amber-900 text-white overflow-hidden">
        {/* Cinematic glow orbs */}
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          <div className="absolute top-[10%] right-[15%] w-48 h-48 bg-amber-500/10 rounded-full blur-3xl" />
          <div className="absolute bottom-[15%] left-[20%] w-40 h-40 bg-orange-500/10 rounded-full blur-3xl" />
          {/* Floating particles */}
          <div className="absolute top-[15%] left-[15%] w-2 h-2 bg-amber-400 rounded-full animate-pulse" style={{ animationDuration: '2s' }} />
          <div className="absolute top-[30%] right-[25%] w-1.5 h-1.5 bg-orange-300 rounded-full animate-pulse" style={{ animationDuration: '3s', animationDelay: '0.5s' }} />
          <div className="absolute bottom-[20%] left-[30%] w-2 h-2 bg-yellow-400 rounded-full animate-pulse" style={{ animationDuration: '2.5s', animationDelay: '1s' }} />
          <div className="absolute top-[45%] right-[15%] w-1 h-1 bg-amber-300 rounded-full animate-pulse" style={{ animationDuration: '4s', animationDelay: '1.5s' }} />
          <div className="absolute bottom-[35%] right-[30%] w-1.5 h-1.5 bg-orange-400 rounded-full animate-pulse" style={{ animationDuration: '3.5s', animationDelay: '0.8s' }} />
        </div>
