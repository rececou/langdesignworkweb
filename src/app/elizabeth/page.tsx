          ...
          __html: JSON.stringify({
            ...
            "@graph": [
              ...
              },
              {
                "@type": "WebPage",
                url: `${SITE_URL}${PAGE_PATH}`,
                name: "Elizabeth Xiaoyue Lang | Art & Custom Design | LangDesignWork",
                description: "Explore the creative journey of Elizabeth Xiaoyue Lang, featuring artworks inspired by those around her and inviting you to discover more.",
                primaryImageOfPage: {
                  "@type": "ImageObject",
                  url: "https://www.langdesignwork.com/images/og-elizabeth.png",
                },
              },
              {
                "@type": "VisualArtwork",
                "@id": "https://www.langdesignwork.com/elizabeth#railway",
                name: "Elizabeth Xiaoyue Railway",
                description: "A model railway station primarily constructed from cardboard and recycled materials, designed during a summer short course at Central Saint Martins College of Art, London, in 2025.",
                image: `${SITE_URL}/images/elizabeth-railway.jpg`,
                dateCreated: "2025",
                artMedium: "Cardboard and recycled materials",
                artform: "Architecture Model",
                creator: { "@type": "Person", name: "Elizabeth Xiaoyue Lang" },
              },
              {
                "@type": "VisualArtwork",
                "@id": "https://www.langdesignwork.com/elizabeth#silent-eyes",
                name: "Silent Eyes",
                description: "A mixed-media piece combining watercolour and paper crafts to create a captivating 3D effect, presented at the HKUST Colors of Inclusion Artwork Exhibition in 2024.",
                image: `${SITE_URL}/images/elizabeth-silent-eyes.jpg`,
                dateCreated: "2024",
                artMedium: "Watercolour and paper craft",
                artform: "Mixed Media",
                creator: { "@type": "Person", name: "Elizabeth Xiaoyue Lang" },
              },
              {
                "@type": "VisualArtwork",
                "@id": "https://www.langdesignwork.com/elizabeth#fleeting-moment",
                name: "Fleeting Moment",
                description: "First oil painting by Elizabeth Xiaoyue Lang, created during her time at the Hong Kong Art School in 2025.",
                image: `${SITE_URL}/images/elizabeth-oil-painting.jpg`,
                dateCreated: "2025",
              ...
              {
                "@type": "VisualArtwork",
                "@id": "https://www.langdesignwork.com/elizabeth#land-of-ma",
                name: "Land of Ma",
                description: "A pen drawing created for mum's birthday, expressing appreciation for all parents.",
                image: `${SITE_URL}/images/elizabeth-land-of-ma.jpg`,
                artMedium: "Colour pens",
                artform: "Drawing",
                creator: { "@type": "Person", name: "Elizabeth Xiaoyue Lang" },
              },
              {
                "@type": "ImageGallery",
                name: "Elizabeth's Artworks Gallery",
                description: "A collection of artworks by Elizabeth Xiaoyue Lang created since 2023, including pastels, pencil drawings, marker art, watercolour, and sketches.",
                url: `${SITE_URL}${PAGE_PATH}`,
                image: [
                  {
                    "@type": "ImageObject",
                    "@id": "https://www.langdesignwork.com/elizabeth#joy",
                    contentUrl: `${SITE_URL}/images/elizabeth-joy.jpg`,
                    name: "Joy",
                    description: "Happy portrait in pastels, created in Hong Kong.",
                    artMedium: "Pastels",
                    creator: { "@type": "Person", name: "Elizabeth Xiaoyue Lang" },
                  },
                  {
                    "@type": "ImageObject",
                    "@id": "https://www.langdesignwork.com/elizabeth#wonder",
                    contentUrl: `${SITE_URL}/images/elizabeth-yeye.jpg`,
                    name: "Wonder",
                    description: "Still life pencil drawing, created in Beijing.",
                    artMedium: "Pencil",
                    creator: { "@type": "Person", name: "Elizabeth Xiaoyue Lang" },
                  },
                  {
                    "@type": "ImageObject",
                    "@id": "https://www.langdesignwork.com/elizabeth#peaceful",
                    contentUrl: `${SITE_URL}/images/elizabeth-girl.jpg`,
                    name: "Peaceful",
                    description: "Girl portrait in pastels, created in Hong Kong.",
                    artMedium: "Pastels",
                    creator: { "@type": "Person", name: "Elizabeth Xiaoyue Lang" },
                  },
                  {
                    "@type": "ImageObject",
                    "@id": "https://www.langdesignwork.com/elizabeth#cherished",
                    contentUrl: `${SITE_URL}/images/elizabeth-cherished.jpg`,
                    name: "Cherished",
                    description: "Marker art created in Mülheim, Germany.",
                    artMedium: "Marker",
                    creator: { "@type": "Person", name: "Elizabeth Xiaoyue Lang" },
                  },
                  {
                    "@type": "ImageObject",
                    "@id": "https://www.langdesignwork.com/elizabeth#moon-cheese",
                    contentUrl: `${SITE_URL}/images/elizabeth-moon-cheese.svg`,
                    name: "Moon Cheese",
                    description: "Watercolour illustration.",
                    artMedium: "Watercolour",
                    creator: { "@type": "Person", name: "Elizabeth Xiaoyue Lang" },
                  },
                  {
                    "@type": "ImageObject",
                    "@id": "https://www.langdesignwork.com/elizabeth#penguin",
                    contentUrl: `${SITE_URL}/images/elizabeth-penguin.jpg`,
                    name: "Penguin",
                    description: "Penguin sketch.",
                    creator: { "@type": "Person", name: "Elizabeth Xiaoyue Lang" },
                  },
                  {
                    "@type": "ImageObject",
                    "@id": "https://www.langdesignwork.com/elizabeth#butterfly",
                    contentUrl: `${SITE_URL}/images/elizabeth-butterfly.svg`,
                    name: "Butterfly",
                    description: "Butterfly in acrylic colour.",
                    artMedium: "Acrylic",
                    creator: { "@type": "Person", name: "Elizabeth Xiaoyue Lang" },
                  },
                  {
                    "@type": "ImageObject",
                    "@id": "https://www.langdesignwork.com/elizabeth#heart-pen",
                    contentUrl: `${SITE_URL}/images/elizabeth-heart.jpg`,
                    name: "Heart Pen",
                    description: "Pen drawing of a heart.",
                    artMedium: "Pen",
                    creator: { "@type": "Person", name: "Elizabeth Xiaoyue Lang" },
                  },
                ],
